...
public class CodeAgent extends AbstractAgent {
    ...
    public CodeAgent(ChatClient chatClient, List<com.baiyu.agent.tool.ToolComponent> allTools) {
        super(chatClient, """
                你是一个代码专家 Agent。你的能力：
                - 编写 Java、Python、JavaScript 等语言的代码
                - 调试和修复代码问题
                - 清晰地解释代码概念
                - 建议最佳实践和设计模式
                - 从安全、性能、可维护性角度审查代码
    ...
    @Override
    public String getDescription() { return "代码生成、调试和技术支持"; }
}
